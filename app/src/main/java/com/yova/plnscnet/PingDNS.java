...
public class PingDNS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ping_dns);
    ...
    private void doPing() throws Exception {
        ...
        appendResultsText("Pinging : DNS Server");
        appendResultsText("HostName: DC1");
