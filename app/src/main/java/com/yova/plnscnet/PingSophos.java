...
public class PingSophos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ping_sophos);
    ...
    private void doPing() throws Exception {
        ...
        appendResultsText("Pinging : Firewall");
        appendResultsText("HostName: Sophos");
