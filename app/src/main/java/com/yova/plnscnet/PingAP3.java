...
public class PingAP3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ping_ap3);
    ...
    private void doPing() throws Exception {
        ...
        appendResultsText("Pinging : Access Point 3");
        appendResultsText("HostName: Unifi");
