...
public class PingVMWare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ping_vmware);
    ...
    private void doPing() throws Exception {
        ...
        appendResultsText("Pinging : VMware ESXi");
        appendResultsText("HostName: VMware Server 59");
