...
public class PingAP2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ping_ap2);
    ...
    private void doPing() throws Exception {
        ...
        appendResultsText("Pinging : Access Point 2");
