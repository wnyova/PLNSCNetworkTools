...
public class PingSAN extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ping_san);
    ...
    private void doPing() throws Exception {
        String ipAddress = ("drive.google.com");
        ...
        appendResultsText("Pinging : SAN Server");
        appendResultsText("HostName: Synology");
