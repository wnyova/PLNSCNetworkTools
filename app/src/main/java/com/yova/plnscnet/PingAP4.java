...
public class PingAP4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ping_ap4);
    ...
    private void doPing() throws Exception {
        ...
        appendResultsText("Pinging : Access Point 4");
